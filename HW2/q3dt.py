...
def main():
    ...
    dtClass = DecisionTreeClassifier(max_depth=1,
                                     min_samples_leaf=1)
    #print(dtClass.get_params())
    aucTrain2, aucVal2, time2 = kfold_cv(dtClass, xTrain, yTrain, 2)
    aucTrain3, aucVal3, time3 = kfold_cv(dtClass, xTrain, yTrain, 3)
    aucTrain4, aucVal4, time4 = kfold_cv(dtClass, xTrain, yTrain, 4)
    aucTrain5, aucVal5, time5 = kfold_cv(dtClass, xTrain, yTrain, 5)
    aucTrain6, aucVal6, time6 = kfold_cv(dtClass, xTrain, yTrain, 6)
    aucTrain7, aucVal7, time7 = kfold_cv(dtClass, xTrain, yTrain, 7)
    aucTrain8, aucVal8, time8 = kfold_cv(dtClass, xTrain, yTrain, 8)
    aucTrain9, aucVal9, time9 = kfold_cv(dtClass, xTrain, yTrain, 9)
    aucTrain10, aucVal10, time10 = kfold_cv(dtClass, xTrain, yTrain, 10)
